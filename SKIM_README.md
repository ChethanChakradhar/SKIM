...
A note on privacy: receipts are personal data. Use a paid Gemini API key, since on the free tier Google may use your inputs to improve its products. Raw photos in `data/raw/` are gitignored.
